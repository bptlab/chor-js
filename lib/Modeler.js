...
import { emptyDiagram } from '../assets/emptyDiagram';
 ...
 */
export function Modeler(options) {
...
Modeler.prototype.openEmptyDiagram = function(options) {
  return this.importXML(emptyDiagram, options);
};
