...
import ToggleShapeVisibilityHandler from './cmd/ToggleShapeVisibilityHandler';
...
ChoreoModeling.prototype.getHandlers = function() {
  ...
  handlers['shape.toggleVisibility'] = ToggleShapeVisibilityHandler;
...
ChoreoModeling.prototype.toggleVisibility = function(shape) {
  this._commandStack.execute('shape.toggleVisibility', {
    shape: shape,
  });
};