...
ChoreoModeling.prototype.getHandlers = function() {
  ...
  handlers['linkCallChoreo'] = LinkCallChoreoHandler;
  return handlers;
};
...
ChoreoModeling.prototype.linkCallChoreo = function(callChoreo, currentLink, choreoToLink) {
  this._commandStack.execute('linkCallChoreo', {
    element: callChoreo, oldLink: currentLink, newLink: choreoToLink
  });
};