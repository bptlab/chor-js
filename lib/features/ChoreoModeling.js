...
ChoreoModeling.prototype.getHandlers = function() {
  ...
  handlers['loopType.add'] = ChangeLoopTypeMarkerHandler;
...
ChoreoModeling.prototype.attachLoopTypeMarker = function(activityShape) {
  //activity.businessObject.loopType = 'Standard';
  this._commandStack.execute('loopType.add', {
    activityShape: activityShape,
