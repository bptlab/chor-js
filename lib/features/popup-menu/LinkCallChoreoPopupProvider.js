 ...
 * @constructor
 */
export default function LinkCallChoreoPopupProvider(popupMenu, modeling, choreoUtil) {
  this._modeling = modeling;
  this._choreoUtil = choreoUtil;
  PopupMenuProvider.call(this, popupMenu);
}

inherits(LinkCallChoreoPopupProvider, PopupMenuProvider);

LinkCallChoreoPopupProvider.prototype.getEntries = function(element) {
...
LinkCallChoreoPopupProvider.prototype.getHeaderEntries = function(element) {
...
LinkCallChoreoPopupProvider.prototype.register = function() {
  this._popupMenu.registerProvider('link-provider', this);
};